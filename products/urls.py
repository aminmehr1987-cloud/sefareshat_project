...
urlpatterns = [
    ...
    path('api/backorder_pdf/<int:order_id>/', views.backorder_pdf, name='backorder_pdf'),
    ...
    path('api/finalize-sub-order/', views.finalize_sub_order, name='finalize_sub_order'),
    path('api/finalize-entire-shipment/', views.finalize_entire_shipment, name='finalize_entire_shipment'),
